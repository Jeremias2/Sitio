...
<div class="unlogin">
   ...
   <table padding="5px">
    <tr>
     ...
     <td>
      <input  size="10" type="password" class="inputs" placeholder="Contraseña" name="Pass">
     </td>
     <td>
...
$comprobacion =  $conexion->query("select Nickname, Contraseña from usuarios where Nickname='$post_user' and Contraseña='$post_pass'");

if($comprobacion->num_rows == 1){
 $_SESSION['Usuario'] = $post_user;

     $_SESSION['Contraseña'] = $post_pass;
